...
// It is the single source of truth for rendering AI credit progress and for warning
// thresholds. accountID is used both in the URL path and as the X-Account-ID header for
// authentication.
